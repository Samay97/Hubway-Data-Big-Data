...
class RemoveFileOperator(BaseOperator):
    ...
    @apply_defaults
    def __init__(self, path: str, file: str, **kwargs) -> None:
        """
        :param dataset: path to file
        :type dataset: string
        :param file: file wich shoud be removed
        :type file: string
        """
